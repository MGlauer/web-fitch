...
function peg$parse(input, options) {
    ...
    var peg$f0 = function (q, v, s) {
        return {type: "quantSen", quant: q, vari: v, sen: s};
    };
    var peg$f1 = function (left, more) {
        return flatten(left, more);
    };
    var peg$f2 = function (n, s) {
        return {type: "un", data: {op: n, sen: s}};
    };
    var peg$f3 = function (left) {
        return left;
    };
    var peg$f4 = function (pred, par) {
        if (!par) {
            return {type: "atom", const: pred};
        } else {
            return {type: "pred", data: {pred: pred, terms: par[1]}}
        }
        ;
    };
    var peg$f5 = function () {
    ...
    var peg$f7 = function (fun, par) {
        if (!par) {
            return {type: "const", const: fun};
        } else {
            return {type: "fun", data: {fun: fun, terms: par[1]}};
        }
    };
    var peg$f8 = function () {
        return "&"
